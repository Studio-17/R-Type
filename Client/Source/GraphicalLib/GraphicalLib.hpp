...
namespace rtype {
    ...
    class GraphicalLib : public IGraphicalLib {
        public:
             ...
             */
            std::shared_ptr<Sprite> createSprite(std::string const &imagePath, float const &size) override;
            /**
            ...
            void drawSprite(std::shared_ptr<Sprite> const &sprite, Position const &position) override;
